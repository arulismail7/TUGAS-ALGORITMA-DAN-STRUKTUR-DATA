...
public class PerpustakaanNusaPutra {
    ...
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("20200040001", "Sahrul ismail usman"));
        dataMahasiswa.add(new Mahasiswa("20200040002", "Umar Falah"));
        dataMahasiswa.add(new Mahasiswa("20200040003", "Rangga Pangestu"));
        dataMahasiswa.add(new Mahasiswa("20200040004", "Zulfikar"));
